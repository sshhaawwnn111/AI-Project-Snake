...
history1 = deque(maxlen=50) # popleft()
history2 = deque(maxlen=50) # popleft()
def train():
    plot_scores1 = []
    plot_scores2 = []
    plot_mean_scores1 = []
    ...
    while True:
        ...
        if done == True:
            ...
            plot_scores1.append(game.score1)
            plot_scores2.append(game.score2)
            # total_score += game.score1
            history1.append(game.score1)
            history2.append(game.score2)
            total_score1 = 0
            total_score2 = 0
            for i in history1:
                total_score1 += i
            for j in history2:
                total_score2 += j
            mean_score1 = total_score1 / len(history1)
            mean_score2 = total_score2 / len(history2)
